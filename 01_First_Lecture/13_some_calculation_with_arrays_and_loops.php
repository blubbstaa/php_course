...
$testFunction = function(){
    ...
    /*BEGIN TODO
    We go another step further in abstraction. In the last exercise sheet, you learned how to use the foreach loop.
    We have now the possibility to use arrays instead of thousends of variable names,
    to store similar information. And we can use foreach loop to calculate things foreach element in an array
